  ...
  <q-layout view="hHh lpR fFf" class="app-shell">
    ...
    <q-drawer v-model="leftDrawerOpen" show-if-above bordered :width="280" class="app-drawer">
      ...
      <q-list class="q-mt-md">
        ...
        <q-item to="/data-management" clickable v-ripple class="drawer-nav-item q-mx-md rounded-borders"
          active-class="drawer-active">
          <q-item-section avatar>
            <q-icon name="o_storage" size="22px" />
          </q-item-section>
          <q-item-section>
            <q-item-label class="text-weight-medium">{{ t('dataManagement') }}</q-item-label>
          </q-item-section>
        </q-item>
